...
fileprivate struct Ticker: Codable {
    ...
    private func platformMatches(_ platform: String, server: RPCServer) -> Bool {
        ...
        case .velas, .velas_testnet, .poa, .kovan, .sokol, .callisto, .goerli, .artis_sigma1, .artis_tau1, .binance_smart_chain_testnet, .ropsten, .rinkeby, .heco, .heco_testnet, .fantom_testnet, .avalanche_testnet, .mumbai_testnet, .custom, .optimistic, .optimisticKovan, .cronosTestnet, .palm, .palmTestnet, .arbitrumRinkeby:
            return false
        }
    }
    ...
    private func isServerSupported(_ server: RPCServer) -> Bool {
        ...
        case .velas: return true
        case .arbitrum: return true
        case .fantom: return true
        case .palm: return true
        case .velas_testnet, .poa, .kovan, .sokol, .callisto, .goerli, .artis_sigma1, .artis_tau1, .binance_smart_chain_testnet, .ropsten, .rinkeby, .heco, .heco_testnet, .fantom_testnet, .avalanche_testnet, .mumbai_testnet, .custom, .optimistic, .optimisticKovan, .cronosTestnet, .palmTestnet, .arbitrumRinkeby:
            return false
        }
    }
}
