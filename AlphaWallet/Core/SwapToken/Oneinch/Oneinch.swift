...
class Oneinch: TokenActionsProvider, SwapTokenURLProviderType {
    ...
    private var supportedServers: [RPCServer] {
        return [.main, .binance_smart_chain, .polygon,.velas, .optimistic, .arbitrum]
    }
