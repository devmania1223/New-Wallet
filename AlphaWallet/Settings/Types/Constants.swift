...
public struct Constants {
    ...
    public static let velasMagicLinkHost = "aw.app"
    public static let velasTestMagicLinkHost = "aw.app"
    ...
    //Wagyu token info
    public static let wagyuAddress = AlphaWallet.Address(string: "0xaBf26902Fd7B624e0db40D31171eA9ddDf078351")
    public static let wagyuName = "WagyuSwap Token"
    public static let wagyuSymbol = "WAG"
    public static let wagyuDecimals = 18
    //Wagyu Swap
    public static let wagyuSwap = "https://exchange.wagyuswap.app/swap"
    // Magic link networks
    ...
    static let defaultEnabledTestnetServers: [RPCServer] = [.velas_testnet]
