...
enum RPCServer: Hashable, CaseIterable {
    ...
    var name: String {
        ...
        case .velas_testnet: return "Velas Testnet"
    ...
    var isTestnet: Bool {
        switch self {
        case .xDai, .classic, .main, .poa, .callisto, .binance_smart_chain, .artis_sigma1, .heco, .fantom, .avalanche, .polygon,.velas, .optimistic, .arbitrum, .palm:
            return false
        case .velas_testnet, .kovan, .ropsten, .rinkeby, .sokol, .goerli, .artis_tau1, .binance_smart_chain_testnet, .heco_testnet, .fantom_testnet, .avalanche_testnet, .mumbai_testnet, .optimisticKovan, .cronosTestnet, .palmTestnet, .arbitrumRinkeby:
            return true
        case .custom(let custom):
    ...
    var customRpc: CustomRPC? {
        switch self {
        case .xDai, .classic, .main, .poa, .callisto, .binance_smart_chain, .artis_sigma1, .heco, .fantom, .avalanche, .polygon, .velas, .velas_testnet, .optimistic, .kovan, .ropsten, .rinkeby, .sokol, .goerli, .artis_tau1, .binance_smart_chain_testnet, .heco_testnet, .fantom_testnet, .avalanche_testnet, .mumbai_testnet, .optimisticKovan, .cronosTestnet, .arbitrum, .arbitrumRinkeby, .palm, .palmTestnet:
            return nil
        case .custom(let custom):
            return custom
        }
    ...
    var etherscanURLForGeneralTransactionHistory: URL? {
        switch self {
        case .main, .ropsten, .rinkeby, .kovan, .poa, .classic, .goerli, .xDai, .artis_sigma1, .artis_tau1, .polygon, .velas, .velas_testnet, .binance_smart_chain, .binance_smart_chain_testnet, .sokol, .callisto, .optimistic, .optimisticKovan, .cronosTestnet, .custom, .arbitrum, .arbitrumRinkeby, .palm, .palmTestnet:
    ...
    var etherscanWebpageRoot: URL? {
        let urlString: String? = {
            ...
            case .velas: return "https://evmexplorer.velas.com"
            case .velas_testnet: return "https://testnet.velascan.org"
    ...
    var etherscanApiRoot: URL? {
        let urlString: String? = {
            ...
            case .velas: return "https://"
            case .velas_testnet: return "https://"
    ...
    private var etherscanCompatibleType: EtherscanCompatibleType {
        switch self {
        case .main, .ropsten, .rinkeby, .kovan, .goerli, .fantom, .heco, .heco_testnet, .optimistic, .optimisticKovan, .binance_smart_chain, .binance_smart_chain_testnet, .polygon,.velas,.velas_testnet, .arbitrum, .arbitrumRinkeby:
            return .etherscan
    ...
    var etherscanApiKey: String? {
        ...
        case .fantom, .heco, .heco_testnet, .binance_smart_chain_testnet:
            return nil
        case .velas, .velas_testnet, .poa, .sokol, .classic, .xDai, .artis_sigma1, .artis_tau1, .callisto, .fantom_testnet, .avalanche, .avalanche_testnet, .cronosTestnet, .palm, .palmTestnet, .custom:
            return nil
        }
    }
    ...
    var erc20AddressForNativeToken: AlphaWallet.Address? {
        ...
        case .main, .ropsten, .rinkeby, .kovan, .goerli, .fantom, .heco, .heco_testnet, .binance_smart_chain, .binance_smart_chain_testnet, .polygon,.velas, .velas_testnet, .poa, .sokol, .classic, .xDai, .artis_sigma1, .artis_tau1, .mumbai_testnet, .callisto, .cronosTestnet, .fantom_testnet, .avalanche, .avalanche_testnet, .custom, .arbitrum, .arbitrumRinkeby, .palm, .palmTestnet:
            return nil
        }
    }
    ...
    var canUserChangeGas: Bool {
        switch self {
        case .main, .ropsten, .rinkeby, .kovan, .goerli, .fantom, .heco, .heco_testnet, .binance_smart_chain, .binance_smart_chain_testnet, .polygon,.velas, .velas_testnet, .poa, .sokol, .classic, .xDai, .artis_sigma1, .artis_tau1, .mumbai_testnet, .callisto, .cronosTestnet, .fantom_testnet, .avalanche, .avalanche_testnet, .custom, .arbitrum, .palm, .palmTestnet:
            return true
    ...
    var symbol: String {
        ...
        case .velas, .velas_testnet: return "VLX"
    ...
    var web3Network: Networks {
        ...
        case .ropsten: return .Ropsten
        case .rinkeby: return .Rinkeby
        case .poa, .sokol, .classic, .callisto, .xDai, .goerli, .artis_sigma1, .artis_tau1, .binance_smart_chain, .binance_smart_chain_testnet, .heco, .heco_testnet, .fantom, .fantom_testnet, .avalanche, .custom, .avalanche_testnet, .polygon, .velas, .velas_testnet,  .mumbai_testnet, .optimistic, .optimisticKovan, .cronosTestnet, .arbitrum, .arbitrumRinkeby, .palm, .palmTestnet:
    ...
    var magicLinkHost: String {
        ...
        case .velas:
            return Constants.velasMagicLinkHost
        case .velas_testnet:
            return Constants.velasTestMagicLinkHost
        case .mumbai_testnet:
    ...
    var rpcURL: URL {
        let urlString: String = {
            ...
            case .velas: return "https://evmexplorer.velas.com/rpc"
            case .velas_testnet: return "https://evmexplorer.testnet.velas.com/rpc"
    ...
    var transactionInfoEndpoints: URL? {
        switch self {
        case .main, .kovan, .ropsten, .rinkeby, .goerli, .classic, .poa, .xDai, .sokol, .artis_sigma1, .artis_tau1, .binance_smart_chain, .binance_smart_chain_testnet, .fantom, .polygon,.velas, .velas_testnet, .mumbai_testnet, .heco, .heco_testnet, .callisto, .optimistic, .optimisticKovan, .cronosTestnet, .custom, .arbitrum, .arbitrumRinkeby, .palm, .palmTestnet:
    ...
    var networkRequestsQueuePriority: Operation.QueuePriority {
        switch self {
        case .main, .polygon, .velas:
            return .normal
        case .velas_testnet, .xDai, .kovan, .ropsten, .rinkeby, .poa, .sokol, .classic, .callisto, .goerli, .artis_sigma1, .artis_tau1, .binance_smart_chain, .binance_smart_chain_testnet, .custom, .heco, .heco_testnet, .fantom, .fantom_testnet, .avalanche, .avalanche_testnet, .mumbai_testnet, .optimistic, .optimisticKovan, .cronosTestnet, .arbitrum, .arbitrumRinkeby, .palm, .palmTestnet:
            return .low
        }
    }
    ...
    var blockChainName: String {
        ...
        case .velas:
            return R.string.localizable.blockchainVelas()
        case .velas_testnet:
            return R.string.localizable.blockchainVelasTest()
        case .mumbai_testnet:
    ...
    var blockChainNameColor: UIColor {
        ...
        case .velas: return .red
        case .velas_testnet: return .red
    ...
    var iconImage: UIImage? {
        ...
        case .velas, .velas_testnet:
            return R.image.iconsTokensVelas()
        case .mumbai_testnet:
            return nil
        case .optimistic:
    ...
    func makeMaximumToBlockForEvents(fromBlockNumber: UInt64) -> EventFilter.Block {
        ...
        case .main, .velas, .velas_testnet, .kovan, .ropsten, .rinkeby, .poa, .classic, .callisto, .xDai, .goerli, .artis_sigma1, .artis_tau1, .fantom, .fantom_testnet, .avalanche, .avalanche_testnet, .optimisticKovan, .sokol, .custom, .palm, .palmTestnet:
            return .latest
        }
    }
}
