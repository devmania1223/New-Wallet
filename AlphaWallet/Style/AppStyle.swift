...
func applyStyle() {
    ...
    UINavigationBar.appearance().backgroundColor = Colors.appTintV2
...
extension UINavigationBarAppearance {
    static var defaultAppearence: UINavigationBarAppearance {
        ...
        appearance.backgroundColor = Colors.appTintV2
...
struct Colors {
    ...
    static let appTintV2 = R.color.wagyu()!
...
enum Style {
    ...
    enum Wallet {
        enum Header {
            ...
            static let backgroundColor = Colors.appTintV2
    ...
    enum TabBar {
        enum Background {
            static let color: UIColor = Colors.appTintV2
        }
        enum Separator {
            static let color: UIColor = R.color.mercury()!
        }
    ...
    enum ScrollableSegmentedControl {
        static let configuration = ScrollableSegmentedControlConfiguration(lineConfiguration: ScrollableSegmentedControlHighlightableLineViewConfiguration(lineHeight: 1.0, highlightHeight: 3.0, lineColor: R.color.mercury()!, highLightColor: R.color.wagyu2()!), isProportionalWidth: true, cellSpacing: 0.0, alignmentWhenNotScrollable: .filled, animationDuration: 0.25, animationCurve: .easeInOut)
    }
    enum ScrollableSegmentedControlCell {
        static let configuration = ScrollableSegmentedControlCellConfiguration(backgroundColor: Colors.appTintV2, highlightedTextColor: R.color.wagyu2()!, nonHighlightedTextColor: R.color.dove()!, highlightedFont: R.font.sourceSansProSemibold(size: 15.0)!, nonHighlightedFont: R.font.sourceSansProRegular(size: 15.0)!, cellPadding: 8.0, textBottomPadding: 12.0)
    }
    enum value {
